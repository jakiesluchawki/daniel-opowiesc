...
Podstawą zapisu jest dostarczony fragment, który zaczyna się w trakcie pytania prowadzącego. Nieczytelne miejsca ponownie porównano z pełnym nagraniem opublikowanym przez PJAIT i jego automatycznymi napisami oraz z niezależnym automatycznym odczytem dźwięku tego nagrania. Odtworzono odzyskane fragmenty; nierozstrzygnięte słowa nadal są oznaczone. Zapis lekko zredagowano: dodano interpunkcję oraz usunięto część powtórzeń i wtrąceń.

Jakość dźwięku jest nierówna. **[nieczytelne]** oznacza słowo lub fragment, którego nie udało się wiarygodnie odczytać; **[niepewne: …]** — możliwy, lecz niepotwierdzony odczyt. Etykiety rozmówców pojawiają się w rozpoznawalnych miejscach; pozostałe zmiany wypowiedzi oznaczono myślnikami. Zachowano wszystkie pierwotne znaczniki czasu: odnoszą się do początku dostarczonego fragmentu, nie do całego wydarzenia. Pominięte przedstawienie gościa, uwagi organizacyjne i końcowe podziękowania jawnie oznaczono przy zachowanych znacznikach.

Opinie, szacunki i przewidywania pozostawiono jako wypowiedzi rozmówców. Przywołania cudzych wypowiedzi nie stanowią tu potwierdzenia ich dosłownego brzmienia; parafrazę prowadzącego oznaczono w tekście. Ten zapis jest opracowaniem nagrania, a nie oficjalną publikacją uczestników.

[Oficjalny program panelu](https://aisummit.pja.edu.pl/program-konferencji-ai-summit-pjait/).

[Pełne nagranie konferencji PJAIT — miejsce odpowiadające początkowi tego fragmentu](https://www.youtube.com/watch?v=SurotppGtyA&t=22739s).
...
[Pominięto przedstawienie gościa i zapowiedź organizacyjną.]
...
[Pominięto uwagę organizacyjną o dołączeniu gościa.]
...
— [Pominięto uwagę organizacyjną o następnym panelu.] Ale aktualnie perspektywa jest taka, że, tak jak wspomniałem wcześniej, wszystkie laby… Celem labów od zawsze, i znowu możemy się cofnąć dziesięć lat wcześniej i to będzie mówione, było zmaksymalizowanie tempa rozwoju sztucznej inteligencji. To, że są te modele, które wspaniale programują, nie wynika z tego, że laby chciały zrobić modele, które świetnie programują…
...
[Pominięto przejście organizacyjne do zakończenia.]

**[52:40]**

[Pominięto zakończenie organizacyjne i podziękowania.]
